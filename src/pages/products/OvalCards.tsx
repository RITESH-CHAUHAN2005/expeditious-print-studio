...
const OvalCards = () => {
  ...
  const handleAddToCart = () => {
    addToCart({
      id: Date.now(),
      name: `Oval Visiting Cards (${selectedQuantity} cards)`,
  ...
  const handleCustomize = () => {
    navigate("/customize", {
      state: {
        productName: "Oval Visiting Cards",
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-lg">
                Sophisticated oval-shaped cards that exude elegance and premium quality
              </p>
            </div>
