...
const LeafCards = () => {
  ...
  const features = [
    ...
    "Perfect for environmental brands",
  ];

  const handleAddToCart = () => {
    addToCart({
      id: Date.now(),
      name: `Leaf Visiting Cards (${selectedQuantity} cards)`,
  ...
  const handleCustomize = () => {
    navigate("/customize", {
      state: {
        productName: "Leaf Visiting Cards",
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-lg">
                Nature-inspired leaf-shaped cards for eco-conscious and creative businesses
              </p>
            </div>
